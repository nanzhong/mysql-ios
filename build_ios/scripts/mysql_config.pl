...
my $ldata   = '/Users/nan/src/mysql-ios/install_ios/data';
my $execdir = '/Users/nan/src/mysql-ios/install_ios/bin';
my $bindir  = '/Users/nan/src/mysql-ios/install_ios/bin';

# ----------------------------------------------------------------------
# If installed, search for the compiled in directory first (might be "lib64")
# ----------------------------------------------------------------------

my $pkglibdir = fix_path('/Users/nan/src/mysql-ios/install_ios/lib',"libmysql/relwithdebinfo",
                         "libmysql/release","libmysql/debug","lib/mysql","lib");

my $pkgincludedir = fix_path('/Users/nan/src/mysql-ios/install_ios/include', "include/mysql", "include");
