...
SET(CMAKE_BINARY_DIR "/Users/nan/src/mysql-ios/cmake_build")
...
SET(CWD_DEFINITIONS "HAVE_CONFIG_H;HAVE_OPENSSL;RAPIDJSON_NO_SIZETYPEDEFINE;__STDC_LIMIT_MACROS;__STDC_FORMAT_MACROS;_USE_MATH_DEFINES;HAVE_LIBEVENT1;UNISTR_FROM_STRING_EXPLICIT=explicit;UNISTR_FROM_CHAR_EXPLICIT=explicit")
SET(CMAKE_C_FLAGS " -Wall -Wextra -Wformat-security -Wvla -Wundef -Wmissing-format-attribute -Wwrite-strings -Wconditional-uninitialized -Wextra-semi -Wmissing-noreturn -Wunreachable-code-break -Wunreachable-code-return")
SET(CMAKE_CXX_FLAGS " -Wall -Wextra -Wformat-security -Wvla -Wundef -Wmissing-format-attribute -Woverloaded-virtual -Wno-null-conversion -Wno-unused-private-field -Wconditional-uninitialized -Wheader-hygiene -Wnon-virtual-dtor -Wundefined-reinterpret-cast")
SET(CMAKE_BUILD_TYPE "RelWithDebInfo")
SET(BUILD_IS_SINGLE_CONFIG "FALSE")
SET(CMAKE_C_FLAGS_DEBUG "-fPIC -g -fno-omit-frame-pointer  -DENABLED_DEBUG_SYNC -DSAFE_MUTEX")
SET(CMAKE_CXX_FLAGS_DEBUG "-fPIC -g -fno-omit-frame-pointer -std=c++11  -DENABLED_DEBUG_SYNC -DSAFE_MUTEX")
SET(CMAKE_C_FLAGS_RELWITHDEBINFO "-O2 -ffunction-sections -fdata-sections -fPIC -g -fno-omit-frame-pointer  -DDBUG_OFF")
SET(CMAKE_CXX_FLAGS_RELWITHDEBINFO "-O2 -ffunction-sections -fdata-sections -fPIC -g -fno-omit-frame-pointer -std=c++11  -DDBUG_OFF")
